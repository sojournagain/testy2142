...
#ifndef _testcoin2142RPC_H_
#define _testcoin2142RPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // testcoin2142 is not connected
...
/**
 * testcoin2142 RPC command dispatcher.
 */
class CRPCTable
{
private:
