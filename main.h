...
#ifndef testcoin2142_MAIN_H
#define testcoin2142_MAIN_H
...
public:
    ...
    {
        // testcoin2142: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of testcoin2142s spent by this transaction.
    ...
    /** Amount of testcoin2142s coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // testcoin2142: get transaction coin age
...
public:
    ...
    // testcoin2142: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // testcoin2142: two types of block: proof-of-work or proof-of-stake
    ...
    // testcoin2142: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // testcoin2142: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // testcoin2142: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // testcoin2142: block index flags
    enum
    {
